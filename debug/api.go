...
// See original source: https://github.com/optimism-java/shisui/blob/06751b3ec9fec0b4bbead878bbb7a502dc728692/internal/debug/api.go
//
...
func (*HandlerT) Stacks(filter *string) string {
	...
	if err != nil {
		log.Error("Failed to write goroutine dump", "err", err)
		return ""
	}
