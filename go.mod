...
require (
	...
	github.com/zen-eth/utp-go v0.0.0-20250601092006-0508310c08c3
...
replace github.com/ethereum/go-ethereum => github.com/optimism-java/shisui v1.14.6-0.20250601035333-bda51ce0ffcc
