...
require (
	...
	github.com/zen-eth/utp-go v0.0.0-20250107035711-993fa1882f57 // indirect
...
replace github.com/ethereum/go-ethereum => github.com/optimism-java/shisui v1.14.6-0.20250113075848-d0fa8579890f
